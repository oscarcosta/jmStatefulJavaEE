package com.jm.statefulapp.view.filters;
 ...
 */
@WebFilter(filterName = "NotaFiscalFilter", urlPatterns = {"/nf/*"})
public class NotaFiscalFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("NotaFiscalFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("NotaFiscalFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("NotaFiscalFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder("NotaFiscalFilter(");
